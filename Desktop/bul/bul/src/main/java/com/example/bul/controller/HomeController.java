    package com.example.bul.controller;

    import com.example.bul.model.MemberUserDetails;
    import com.example.bul.service.MemberService;
    ...
    public class HomeController {
        ...
        public String postPassword(
            ...
            memberService.updatePassword(
                    userDetails.getMemberId(),passwordForm.getPassword()
            );
            return "redirect:/";
